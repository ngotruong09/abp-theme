...
public class DemoMenuContributor : IMenuContributor
{
    ...
    private static void FillMainMenu(MenuConfigurationContext context, IStringLocalizer l)
    {
        ...
        AddForms(context, l);
        AddDownloadSourceCodeSection(context, l);
    }
    ...
    private static void AddDashboard(MenuConfigurationContext context, IStringLocalizer l)
    {
        ...
        menu.AddItem(new ApplicationMenuItem(DemoMenu.Dashboard.Dashboard2, l["Dashboard3"], "~/Layouts/Application/Dashboard/Dashboard3"));
    ...
    private static void AddDownloadSourceCodeSection(MenuConfigurationContext context, IStringLocalizer l)
    {
        var menu = new ApplicationMenuItem(
            DemoMenu.DownloadSourceCode,
            l["DownloadSourceCode"],
            icon: "fas fa-code",
            url: "~/DownloadSourceCode"
        );
