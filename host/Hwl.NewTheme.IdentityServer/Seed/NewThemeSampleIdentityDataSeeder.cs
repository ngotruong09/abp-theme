 ...
 * - Hwl.NewTheme.IdentityServer
 * - Hwl.NewTheme.Web.Unified (used as linked file)
 */
public class NewThemeSampleIdentityDataSeeder : ITransientDependency
{
    ...
    public NewThemeSampleIdentityDataSeeder(
