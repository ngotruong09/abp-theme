...
using Hwl.NewTheme.Blazor.WebAssembly;
...
namespace Hwl.NewTheme.Blazor.Host;
...
[DependsOn(
    ...
    typeof(NewThemeBlazorWebAssemblyModule)
)]
public class NewThemeBlazorHostModule : AbpModule
{
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new NewThemeHostMenuContributor(context.Services.GetConfiguration()));
        });
    }
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add("NewTheme");
        });
    }
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<NewThemeBlazorHostModule>();
        });
    }
}
